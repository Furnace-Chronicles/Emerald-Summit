...
/obj/item/reagent_containers/food/snacks/rogue/tomatoplate
	name = "tomatoplate"
	desc = "A culinary delight from the Summit's shores, purported to've originated from an inflow of Etruscean refugees from long ago. The \
...
/obj/item/reagent_containers/food/snacks/rogue/poisontruffletomatoplate
	...
	list_reagents = list(/datum/reagent/consumable/nutriment = MEAL_GOOD + SNACK_CHUNKY, /datum/reagent/toxin/berrypoison = 5)
	faretype = FARE_FINE
	w_class = WEIGHT_CLASS_NORMAL
...
/obj/item/reagent_containers/food/snacks/rogue/poisontruffletomatoplate_slice
	...
	faretype = FARE_FINE
	w_class = WEIGHT_CLASS_NORMAL
	list_reagents = list(/datum/reagent/consumable/nutriment = SNACK_CHUNKY, /datum/reagent/toxin/berrypoison = 5)
	tastes = list("richly smooth and salty tomatoes" = 1, "hot and gooey cheese" = 1, "rubbery and bitter truffles" = 1)
	bitesize = 3
	rotprocess = SHELFLIFE_EXTREME
	dropshrink = 0.8
