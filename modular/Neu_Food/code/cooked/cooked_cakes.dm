...
/obj/item/reagent_containers/food/snacks/rogue/berrycake/poison
	...
	list_reagents = list(/datum/reagent/toxin/berrypoison = 5, /datum/reagent/consumable/nutriment = 48, /datum/reagent/water = 5)
...
/obj/item/reagent_containers/food/snacks/rogue/berrycakeslice/poison
	list_reagents = list(/datum/reagent/toxin/berrypoison = 1, /datum/reagent/consumable/nutriment = SNACK_DECENT, /datum/reagent/water = 1)
