              ...
              <LabeledList>
                ...
                <LabeledList.Item label="Age">
                  <Dropdown
                    ...
                    onSelected={(value) =>
                      value !== id.age && act('set_age_direct', { name: value })
                    }
                  />
                  <Button
                    ml={0.5}
              ...
              <LabeledList>
                <LabeledList.Item label="Virtue">
                  <Dropdown
                    ...
                    options={[id.virtue_name, ...id.virtue_options].map(
                      (name) => ({
                        value: name,
                        displayText: name,
                        ...
                        disabled:
                          name === id.virtuetwo_name &&
                          id.virtuetwo_name !== 'None',
                      }),
                    )}
                    onSelected={(value) =>
