// Magi 2 staged aspect picker — port of Azure-Peak aspect_picker.dm.
// Fork adaptations: ui_state uses GLOB.tgui_always_state; legacy check_learnspell() calls
// dropped (unused); cmp_list_name_asc defined below. Routes through the Phase-A attune model
// (mind.major_aspects / attune_aspect / remove_aspect) and our aspect grant helpers.
