// Ascension — Augmentation Mastery (T4 additive variant). Port of Azure-Peak ascension.dm.
// Dumps the full augmentation buff suite onto a single ally for a heavy energy cost.
...
/datum/action/cooldown/spell/ascension_magi2/cast(atom/cast_on)
	. = ..()
