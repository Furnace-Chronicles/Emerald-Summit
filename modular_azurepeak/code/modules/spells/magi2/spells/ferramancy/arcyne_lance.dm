// Arcyne Lance — Ferramancy piercing projectile. Pierces up to 3 targets.
...
/datum/action/cooldown/spell/projectile/arcyne_lance_magi2
	...
	projectile_type = /obj/projectile/magic/arcyne_lance_magi2
	projectile_type_arc = /obj/projectile/magic/arcyne_lance_magi2/arc
...
/obj/projectile/magic/arcyne_lance_magi2
	name = "arcyne lance"
...
/obj/projectile/magic/arcyne_lance_magi2/arc
	name = "arced arcyne lance"
	damage = 50
	arcshot = TRUE
	max_hits = 1

/obj/projectile/magic/arcyne_lance_magi2/on_hit(target)
	if(ismob(target))
		var/mob/M = target
