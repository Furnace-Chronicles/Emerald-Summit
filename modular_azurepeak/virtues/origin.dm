...
/datum/virtue/origin/avar
	name = "Avar"
	desc = "I originate from the chains of Avar, a stretch of tempestuous islands between the regions of Kazengun and Hammerhold. Constant downpours flood the land, and fog is a constant, leaving settled lands to wrap around its mountain ranges- the tallest in the Known World."
	origin_title = "Avar"
	...
	origin_desc = "For as long as <b>anyone</b> can remember, the land of <b>Avar</b> has been sinking beneath the sea.</p><b>A distant,</b> vanishing land found far to the northeast of the Known World, this chain of islands curves like a scythe from the northerly lands of distant Hammerhold down to the frontier of Kazengun greater. In times longer past - during the reign of the Snow Elves - it was a singular, sloping land that physically connected the brother continents of East and North- and served as the Great Highway between each.<br><br> In the <b>Now,</b> however, Avar is a frigid, rain-swept set of archipelagos; taiga turned tundra as, year-by-year, land is turned low and lowland sinks undersea. <br><br><b>R</b>ain is a constant upon the islands; a never-ending storm that breaks only on the rarest of occasions. Those that live upon its lands vary. Simplest are its perpetually migrant populations; distant tribes of orc and humen, accustomed to the cold and rain, continually moving upwards through generations. Then, there are the <b>fjällshem</b> - broad cities wrapping around the lower ranges of the Aavnic mountains. At their elevation, harsh rain dries into a modest, mostly-opaque fog; frigid, but not unlivable. Only those of the isolationist <b>Falc</b> culture are immune to the rising tides, for they make their homes upon the highest peaks of the land- above the downpour of the cloud layers and away from the petty trifles of the <i>dirtwalkers.</i> All avian species - harpies or full-blooded Avia - can trace their heritage back to the peaks of Avar. <br><br> <b>L</b>ittle remains of the original magnificence of Avar; the <b><i>Golden Highway.</i></b> Though remnants of its higher structures remain, much of this great road has been buried undersea. Dredger vessels from Avar or elsewhere constantly delve into the oceans for relics of the time; pulling up curiosities and brine-corroded artifices with purposes long-forgotten. Meanwhile, bands of northern Lupian <i>druzhyina</i> oft sail through the flooded plains, seeking to plunder the lands of <i>Tigris</i> to the south. While centuries shrink the space given to the land-dwellers, those within the waves are, in contrast, given a growing bounty to explore and conquer. The Seaborne - be they Axians from Flotilla, or migratory tribes of sealmen - have occupied the fresh shallows of Avar; building amphibiously along the rising tide. Deeper still are other, rarer sentient species-- families of vast, predatory Krakkæna prey upon stray longships here, and the complex whalesong of Ceta pods echo sibilant along the Avar lowlands; surfaced sounds amplified by its harsh cliffs. <br><br><b>N</b>ot a soul knows why Avar is aggressively flooding so; though the Pantheonic understanding is that Abyssor, either in rage or desire for change, seeks to sink the land utterly; and the endless rain is His curse and/or blessing. </p><p><sub>Key Cities:</sub> <br><b>Hälssing - Nordåskkorri - Kalevinna - Sumitoivo</b></p>"
