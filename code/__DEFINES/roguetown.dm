...
#define RACES_SHUNNED_UP list(RACES_RESPECTED, RACES_TOLERATED, RACES_SHUNNED, RACES_CONSTRUCT)

#define RACES_DESPIED_UP list(RACES_RESPECTED, RACES_TOLERATED, RACES_SHUNNED, RACES_DESPISED, RACES_CONSTRUCT)
...
#define RACES_SHUNNED_UP_NO_CONSTRUCT list(RACES_TOLERATED, RACES_RESPECTED, RACES_SHUNNED)
