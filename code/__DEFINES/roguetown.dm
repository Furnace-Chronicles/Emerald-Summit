...
//Yeah, yeah, I know. It's a singular patron. Blame the dude who split them.
#define PSYDON_PATRONS  list(/datum/patron/old_god, /datum/patron/old_god/psydonite_hidden)
...
#define CTAG_PONTIFF		"CAT_PONTIFF"		// Pontiff classes. As you'd expect.
