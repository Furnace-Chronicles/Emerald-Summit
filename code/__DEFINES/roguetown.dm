...
#define ARMOR_LEATHER list("blunt" = 38, "slash" = 20, "stab" = 55, "piercing" = 64, "fire" = 0, "acid" = 0)
...
#define ARMOR_MAILLE list("blunt" = 33, "slash" = 100, "stab" = 65, "piercing" = 76, "fire" = 0, "acid" = 0)
