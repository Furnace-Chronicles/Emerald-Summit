...
#define PEASANT_WEAPON 			(1<<13) //Tool or weapon that benefits from TRAIT_PEASANTMILITIA
#define GIANT_WEAPON 			(1<<14) //Weapon designed for giants - requires double STR for non-giants
