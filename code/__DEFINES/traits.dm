...
#define TRAIT_FRESHSPAWN "freshspawn" //marker on freshly-spawned ambush/quest mobs (ported from AP #6849/#7000); set for 60s after spawn, never read - inert marker matching AP
