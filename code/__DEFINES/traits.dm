...
#define TRAIT_CRIMSONCURSE "Crimson Curse" //Crimson Curse Virtue
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_CRIMSONCURSE = span_bloody("You suffer from the Crimson Curse, a weak form of Vampirism acquired from dark rites or a particularly cruel hex. Unlike a 'true' Vampire, you are incapable of converting others or commiting Diablerie."),
