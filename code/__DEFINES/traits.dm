...
#define TRAIT_LYCAN_CURSE "Lycan Curse" // Mini-Werewolves
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_LYCAN_CURSE = span_info("You are cursed by the Treefather. You are a lesser werewolf, and transform into one at night. You cannot infect others with your bite."),
