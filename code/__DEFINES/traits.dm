...
#define TRAIT_DENDOR_BLESSED "Dendor's Blessed" // Mini-Werewolves
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_DENDOR_BLESSED = span_info("You are blessed by the Treefather. You are a lesser werewolf, and transform into one at night. You cannot infect others with your bite."),
