...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_GUARDSMAN = span_info("I am vigilant in my duties. In the town of Readtun, my abilities are sharper due to my routine and familiarity."),
	TRAIT_GUARDSMAN_NOBLE = span_info ("I am vigilant in my duties. In the Keep of Aemerlond, my abilities are sharper due to my routine and familiarity."),
	TRAIT_WOODSMAN = span_info("I am vigilant in my duties. In the grove and coast of Readtun, my abilities are sharper due to my routine and familiarity."),
	...
	TRAIT_RESIDENT = span_info("I've been granted a Meister account, and the ownership of a house in Readtun."),
