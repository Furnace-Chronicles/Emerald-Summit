...
#define HUGBOX
	...
	#define CRIT_OVERKILL_THRESHOLD_EASY		65
	#define CRIT_OVERKILL_THRESHOLD_NORMAL		70
	#define CRIT_OVERKILL_THRESHOLD_HARD		75
	#define CRIT_OVERKILL_THRESHOLD_VERY_HARD	80
#else
