...
/datum/action/cooldown/spell/crescendo
	name = "Crescendo"
	desc = "Land 3 rhythm-empowered strikes to charge your Crescendo. Once charged, activate to prime your next melee hit — unleashing a powerful 3x3 frontal blast based on your last rhythm. You have 8 seconds to strike before it fizzles.\n\n\
	<b>Resonating:</b> Parry-bypassing brute damage.\n\
	<b>Concussive:</b> Brute damage + knockback.\n\
	<b>Frigid:</b> Applies frost stacks to slow and freeze.\n\
	<b>Regenerating (T2 Bard only):</b> Heal-over-time for your audience."
