...
/datum/antagonist/gnoll/proc/get_sniff_spell()
	...
	// Upstream /datum/mind/proc/get_spell absent in ES — fall back to mob_spell_list only.
	return null
...
/datum/antagonist/gnoll/proc/get_tracked_target()
	...
	// Upstream /datum/mind/proc/get_spell absent in ES — mob_spell_list iteration above is authoritative.
