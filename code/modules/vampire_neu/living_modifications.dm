...
/mob/living/carbon/human/proc/handle_bloodpool_effects()
	...
	switch(bloodpool)
		if(VITAE_LEVEL_FED to INFINITY)
			remove_status_effect(/datum/status_effect/debuff/bloodstarved)
			remove_status_effect(/datum/status_effect/debuff/bloodstarvedworse)
			remove_status_effect(/datum/status_effect/debuff/bloodstarvedworst)
		if(VITAE_LEVEL_HUNGRY to VITAE_LEVEL_FED)
			apply_status_effect(/datum/status_effect/debuff/bloodstarved)
			remove_status_effect(/datum/status_effect/debuff/bloodstarvedworse)
			remove_status_effect(/datum/status_effect/debuff/bloodstarvedworst)
		if(VITAE_LEVEL_STARVING to VITAE_LEVEL_HUNGRY)
			apply_status_effect(/datum/status_effect/debuff/bloodstarvedworse)
			remove_status_effect(/datum/status_effect/debuff/bloodstarved)
			remove_status_effect(/datum/status_effect/debuff/bloodstarvedworst)
		if(-INFINITY to VITAE_LEVEL_STARVING)
			apply_status_effect(/datum/status_effect/debuff/bloodstarvedworst)
			remove_status_effect(/datum/status_effect/debuff/bloodstarved)
			remove_status_effect(/datum/status_effect/debuff/bloodstarvedworse)
			if(prob(3))
