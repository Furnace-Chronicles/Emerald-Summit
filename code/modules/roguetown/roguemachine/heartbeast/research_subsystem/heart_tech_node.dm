...
/datum/chimeric_tech_node/basic_organs
	name = "Fleshen Organ Synthesis"
	description = "Allows shaping flesh nodes and beast blood into functioning organs - lungs, hearts, livers, eyes and tongues."
...
/datum/chimeric_tech_node/black_rose
	...
	cost = 100
	selection_weight = 2
	prerequisites = list("BASIC_ORGANS")
	is_recipe_node = TRUE
...
/datum/chimeric_tech_node/infestation_rot_multiple_2
	...
	description = "Infestation now affects 3 additional nearby food item when cast on snacks."
