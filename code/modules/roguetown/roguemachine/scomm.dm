...
/obj/structure/roguemachine/scomm/MiddleClick(mob/living/carbon/human/user)
	if(.)
		return
	if(((user.job == "Dungeoneer") || (user.job == "Sergeant") || (user.job == "Warden") || (user.job == "Hand") || (user.job == "Man at Arms") || (user.job == "Squire") || (user.job == "Marshal") || (user.job == "Grand Duke") || (user.job == "Knight Captain") || (user.job == "Knight") || (user.job == "Consort") || (user.job == "Veteran")))
