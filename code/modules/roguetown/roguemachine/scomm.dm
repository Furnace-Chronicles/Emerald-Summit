...
/datum/scommodule/proc/ring_ring()
	playsound(parent_object, list('sound/misc/scom1.ogg','sound/misc/scom2.ogg','sound/misc/scom3.ogg','sound/misc/scom4.ogg','sound/misc/scom5.ogg'), 100, TRUE, 3)
...
//	icon_state = "scomm[rand(1,2)]"
	scom.setup(src, FALSE, TRUE, TRUE, TRUE, DEFAULT_GARRISON_COLOR, list('sound/misc/scom1.ogg','sound/misc/scom2.ogg','sound/misc/scom3.ogg','sound/misc/scom4.ogg','sound/misc/scom5.ogg'), 80, SCOM_TARGET_COMMONS, TRUE, TRUE, FALSE, FALSE, scom_tag)
...
/obj/item/scomstone/listenstone/scominit()
	scom.setup(src, TRUE, TRUE, TRUE, FALSE, DEFAULT_GARRISON_COLOR, list('sound/misc/scom1.ogg','sound/misc/scom2.ogg','sound/misc/scom3.ogg','sound/misc/scom4.ogg','sound/misc/scom5.ogg'), 80, SCOM_TARGET_COMMONS, TRUE, FALSE, FALSE)
...
/obj/item/scomstone/speakerinq/scominit()
	scom.setup(src, FALSE, FALSE, TRUE, FALSE, DEFAULT_GARRISON_COLOR, list('sound/misc/scom1.ogg','sound/misc/scom2.ogg','sound/misc/scom3.ogg','sound/misc/scom4.ogg','sound/misc/scom5.ogg'), 20, SCOM_TARGET_INQUISITOR, FALSE, FALSE, FALSE, TRUE)
...
/obj/structure/listeningdeviceactive/Initialize()
	. = ..()
	scom.setup(src, TRUE, TRUE, FALSE, FALSE, DEFAULT_GARRISON_COLOR, 'sound/vo/mobs/rat/rat_life.ogg', 80, SCOM_TARGET_INQUISITOR, FALSE, FALSE, FALSE, FALSE)
	become_hearing_sensitive()
...
/obj/structure/broadcast_horn/proc/scominit()
	scom.setup(src, TRUE, TRUE, FALSE, FALSE, DEFAULT_GARRISON_COLOR, list('sound/misc/scom1.ogg','sound/misc/scom2.ogg','sound/misc/scom3.ogg','sound/misc/scom4.ogg','sound/misc/scom5.ogg'), 80, SCOM_TARGET_LOUDMOUTH_STRONG, FALSE, FALSE, FALSE, FALSE)
...
/obj/structure/broadcast_horn/loudmouth/scominit()
	scom.setup(src, TRUE, TRUE, FALSE, FALSE, DEFAULT_GARRISON_COLOR, list('sound/misc/scom1.ogg','sound/misc/scom2.ogg','sound/misc/scom3.ogg','sound/misc/scom4.ogg','sound/misc/scom5.ogg'), 80, SCOM_TARGET_LOUDMOUTH, FALSE, FALSE, FALSE, FALSE)
	scom.active_listening = FALSE
	scom.active_speaking = FALSE
