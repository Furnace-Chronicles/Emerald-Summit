...
/obj/item/organ/liver/t1/Insert(mob/living/carbon/M)
	...
	if(M)
		...
		ADD_TRAIT(M, TRAIT_SEA_DRINKER, TRAIT_GENERIC)
...
/obj/item/organ/liver/t2/Insert(mob/living/carbon/M)
	...
	if(M)
		...
		ADD_TRAIT(M, TRAIT_TOXIMMUNE, TRAIT_GENERIC)
		ADD_TRAIT(M, TRAIT_ZOMBIE_IMMUNE, TRAIT_GENERIC)
		ADD_TRAIT(M, TRAIT_SEA_DRINKER, TRAIT_GENERIC)
...
/obj/item/organ/liver/t2/Remove(mob/living/carbon/M, special = 0)
	...
	if(M.has_status_effect(/datum/status_effect/buff/t2liver))
		...
		REMOVE_TRAIT(M, TRAIT_ZOMBIE_IMMUNE, TRAIT_GENERIC)
		REMOVE_TRAIT(M, TRAIT_SEA_DRINKER, TRAIT_GENERIC)
...
/obj/item/organ/liver/t3/Insert(mob/living/carbon/M)
	...
	if(M)
		...
		ADD_TRAIT(M, TRAIT_ZOMBIE_IMMUNE, TRAIT_GENERIC)
		ADD_TRAIT(M, TRAIT_SEA_DRINKER, TRAIT_GENERIC)
		ADD_TRAIT(M, TRAIT_NOHUNGER, TRAIT_GENERIC)
