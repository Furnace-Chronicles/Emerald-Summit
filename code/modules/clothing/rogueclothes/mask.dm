	...
	if(istype(L, /mob/living/carbon/human))
		...
		for(var/datum/round_event_control/E in SSevents.control)
			if(istype(E, /datum/round_event_control/gobinvade))
				...
				break
		priority_announce("A cursed penitent has been died. As Ravox is distracted, goblins seize the moment to pour forth from their portals and assail the land!", "RAVOX'S DISAPPOINTMENT", 'sound/misc/evilevent.ogg')
