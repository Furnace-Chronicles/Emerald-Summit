...
/client/proc/show_round_stats(featured_stat)
	...
	data += "<font color='#bacfd6'><span class='bold'>Graves Consecrated:</span></font> [GLOB.scarlet_round_stats[STATS_GRAVES_CONSECRATED]]<br>"
	...
	data += "<font color='#77d0cd'><span class='bold'>Non-binary:</span></font> [GLOB.scarlet_round_stats[STATS_OTHER_GENDER]]<br>"
	...
	data += "<font color='#99dfd5'><span class='bold'>Lupians/Venardines & Tabaxi:</span></font> [GLOB.scarlet_round_stats[STATS_ALIVE_LUPIANS] + GLOB.scarlet_round_stats[STATS_ALIVE_VULPS] + GLOB.scarlet_round_stats[STATS_ALIVE_TABAXI]]<br>"
	data += "<font color='#c0c6c7'><span class='bold'>Constructs:</span></font> [GLOB.scarlet_round_stats[STATS_ALIVE_GOLEMS]]<br>"
	...
	var/datum/browser/popup = new(src.mob, "scarlet_roundend", "<center>The Chronicle</center>", 1325, 875)
...
/client/proc/show_chronicle(tab = "The Realm")
	...
	switch(tab)
		...
		if("The Realm")
			...
			data += "<div style='margin-bottom: 4px;'><font color='#f0c759'>Starting Treasury: </font>[GLOB.scarlet_round_stats[STATS_STARTING_TREASURY]]</div>"
			data += "<div style='margin-bottom: 4px;'><font color='#e67e22'>Noble Estates Revenue: </font>[GLOB.scarlet_round_stats[STATS_NOBLE_INCOME_TOTAL]]</div>"
			data += "<div style='margin-bottom: 4px;'><font color='#ce9d15'>Rural Taxes Collected: </font>[GLOB.scarlet_round_stats[STATS_RURAL_TAXES_COLLECTED]]</div>"
			data += "<div style='margin-bottom: 4px;'><font color='#f5c02e'>Royal Taxes Collected: </font>[GLOB.scarlet_round_stats[STATS_TAXES_COLLECTED]]</div>"
			data += "<div style='margin-bottom: 4px;'><font color='#8fa36a'>Mammons Deposited: </font>[GLOB.scarlet_round_stats[STATS_MAMMONS_DEPOSITED]]</div>"
			data += "<div style='margin-bottom: 4px;'><font color='#90b34f'>Stockpile Exports: </font>[GLOB.scarlet_round_stats[STATS_STOCKPILE_EXPORTS_VALUE]]</div>"
			data += "<div style='margin-bottom: 4px;'><font color='#a2b337'>Bought from Stockpile: </font>[GLOB.scarlet_round_stats[STATS_STOCKPILE_REVENUE]]</div>"
			data += "<div style='border-top: 1px solid #555; margin: 8px 0;'></div>"
			data += "<div style='margin-bottom: 4px;'><font color='#23ba30'>Total Revenue: </font>[GLOB.scarlet_round_stats[STATS_STARTING_TREASURY]  + GLOB.scarlet_round_stats[STATS_NOBLE_INCOME_TOTAL] + GLOB.scarlet_round_stats[STATS_TAXES_COLLECTED] + GLOB.scarlet_round_stats[STATS_MAMMONS_DEPOSITED] + GLOB.scarlet_round_stats[STATS_STOCKPILE_EXPORTS_VALUE] + GLOB.scarlet_round_stats[STATS_STOCKPILE_REVENUE] + GLOB.scarlet_round_stats[STATS_RURAL_TAXES_COLLECTED]]</div>"
			data += "</div></div>"

			// Right column (Expenses)
			data += "<div style='width: 44%; display: flex; justify-content: flex-start;'>"
			data += "<div style='text-align: left; padding-left: 20px;'>"
			data += "<div style='margin-bottom: 4px;'><font color='#c95555'>Mammons Withdrawn: </font>[GLOB.scarlet_round_stats[STATS_MAMMONS_WITHDRAWN]]</div>"
			data += "<div style='margin-bottom: 4px;'><font color='#db853d'>Stockpile Imports: </font>[GLOB.scarlet_round_stats[STATS_STOCKPILE_IMPORTS_VALUE]]</div>"
			data += "<div style='border-top: 1px solid #555; margin: 8px 0;'></div>"
			data += "<div style='margin-bottom: 4px;'><font color='#c44731'>Total Expenses: </font>[GLOB.scarlet_round_stats[STATS_MAMMONS_WITHDRAWN] + GLOB.scarlet_round_stats[STATS_STOCKPILE_IMPORTS_VALUE]]</div>"
			data += "</div></div>"
			...
			data += "<div style='width: 44%; display: flex; justify-content: flex-end;'>"
			data += "<div style='text-align: left; padding-right: 20px;'>"
			data += "<div style='margin-bottom: 4px;'><font color='#caa64a'>Bathmatron Vault Revenue: </font>[GLOB.scarlet_round_stats[STATS_BATHMATRON_VAULT_TOTAL_REVENUE]]</div>"
			data += "<div style='margin-bottom: 4px;'><font color='#c57e62'>Sold to Stockpile: </font>[GLOB.scarlet_round_stats[STATS_STOCKPILE_EXPANSES]]</div>"
			data += "<div style='margin-bottom: 4px;'><font color='#b6a17f'>Salary Payments: </font>[GLOB.scarlet_round_stats[STATS_WAGES_PAID]]</div>"
			data += "<div style='margin-bottom: 4px;'><font color='#aac484'>Treasury Transfers: </font>[GLOB.scarlet_round_stats[STATS_DIRECT_TREASURY_TRANSFERS]]</div>"
			data += "<div style='margin-bottom: 4px;'><font color='#c78445'>Royal Fines Collected: </font>[GLOB.scarlet_round_stats[STATS_FINES_INCOME]]</div>"
			data += "<div><font color='#e74c3c'>Royal Taxes Evaded: </font>[GLOB.scarlet_round_stats[STATS_TAXES_EVADED]]</div>"
			data += "</div></div>"

			// Right column
			data += "<div style='width: 44%; display: flex; justify-content: flex-start;'>"
			data += "<div style='text-align: left; padding-left: 20px;'>"
			data += "<div style='margin-bottom: 4px;'><font color='#ebbf49'>Mammons Circulating: </font>[GLOB.scarlet_round_stats[STATS_MAMMONS_HELD]]</div>"
			data += "<div style='margin-bottom: 4px;'><font color='#db9a59'>Trade Value Exported: </font>[GLOB.scarlet_round_stats[STATS_TRADE_VALUE_EXPORTED]]</div>"
			data += "<div style='margin-bottom: 4px;'><font color='#dfbf57'>Trade Value Imported: </font>[GLOB.scarlet_round_stats[STATS_TRADE_VALUE_IMPORTED]]</div>"
			data += "<div style='margin-bottom: 4px;'><font color='#c0b283'>GOLDFACE Imports: </font>[GLOB.scarlet_round_stats[STATS_GOLDFACE_VALUE_SPENT]]</div>"
			data += "<div style='margin-bottom: 4px;'><font color='#c0b283'>SILVERFACE Imports: </font>[GLOB.scarlet_round_stats[STATS_SILVERFACE_VALUE_SPENT]]</div>"
			data += "<div style='margin-bottom: 4px;'><font color='#b5a642'>PURITY Imports: </font>[GLOB.scarlet_round_stats[STATS_PURITY_VALUE_SPENT]]</div>"
			data += "<div><font color='#7495d3'>Peddler Revenue: </font>[GLOB.scarlet_round_stats[STATS_PEDDLER_REVENUE]]</div>"
			data += "</div></div>"
...
/client/proc/show_influences(debug = FALSE)
	...
	src.mob << browse(null, "window=scarlet_roundend")
...
/proc/god_ui_block(name, bg_color, title_color, datum/storyteller/storyteller, debug = FALSE)
	...
	if(!debug)
		...
		for(var/stat in initialized_storyteller.influence_factors)
			...
			var/stat_value = GLOB.scarlet_round_stats[stat] || 0
