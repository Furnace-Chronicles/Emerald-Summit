/datum/job/roguetown/hand
	...
	tutorial = "Whether by outstanding merit or petty favoritism, you are the Duke’s most trusted representative and advisor. Your authority is second only to the Duke himself. The weight of your words can shape policy, stir conflict, or silence dissent. Let none forget whose will you carry, and do not fail your benefactor."
	whitelist_req = TRUE
