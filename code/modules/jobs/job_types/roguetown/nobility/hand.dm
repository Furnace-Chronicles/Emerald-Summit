/datum/job/roguetown/hand
	...
	tutorial = "Whether by outstanding merit or petty favoritism, you are the Duke’s most trusted representative and advisor, and your authority is second only to his. The weight of your words can shape policy, stir conflict, or silence dissent. The Duke may wear the crown, but it is you who pulls the strings. Let none forget whose will you carry, and do not fail your benefactor."
	whitelist_req = TRUE
