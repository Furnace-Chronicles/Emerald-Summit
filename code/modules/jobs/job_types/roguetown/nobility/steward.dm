...
/mob/living/carbon/human/proc/adjust_taxes()
	...
	if(newtax)
		...
		priority_announce("The new tax in Emerald Summit shall be [newtax] percent.", "The Steward Meddles", pick('sound/misc/royal_decree.ogg', 'sound/misc/royal_decree2.ogg'), "Captain")
