...
/proc/wretch_select_bounty(mob/living/carbon/human/H)
	...
	if(bounty_face_noface == "Yes")
		var/bounty_poster = input(H, "Who placed a bounty on you?", "Bounty Poster") as anything in list("The Justiciary of Emerald Summit", "The Grenzelhoftian Holy See", "The Otavan Holy See")
		if(bounty_poster == "The Justiciary of Emerald Summit")
	...
	if(bounty_face_noface == "No")
		...
		var/bounty_poster = "The Justiciary of Emerald Summit"
		var/bounty_severity = input(H, "How severe are your crimes?", "Bounty Amount") as anything in list("Misdeed", "Harm towards lyfe", "Horrific atrocities")
		var/bounty_total = rand(100, 400) // Just in case
		switch(bounty_severity)
			if("Misdeed")
