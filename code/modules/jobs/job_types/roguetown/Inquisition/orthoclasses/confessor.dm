/datum/advclass/confessor
	name = "Confessor"
	tutorial = "Church of the Amora holy hunters, unmatched in the fields of subterfuge and investigation. There is no suspect too powerful to investigate, no room too guarded to infiltrate, and no weakness too hidden to exploit."
