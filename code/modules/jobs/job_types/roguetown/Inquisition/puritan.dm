/datum/job/roguetown/puritan
	...
	tutorial = "You have been sent here as an envoy from the Sovereignty of Holy see of the Amora : a silver-tipped olive branch, unmatched in aptitude and unshakable in faith to the Amora. Though you might be ostracized due to your overzealous beliefs, neither the Church nor Crown can deny your value, whenever matters of inhumenity arise to threaten this fief."
	whitelist_req = TRUE
