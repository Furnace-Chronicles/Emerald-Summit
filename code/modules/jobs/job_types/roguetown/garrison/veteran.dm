...
/datum/advclass/veteran/merc
	...
	classes = list("Grenzelhoft" = "Having once served with zweihandler or halberd in the professional echelons of the Grenzelhoft mercenary guild, they are now free from the guild to pursue lordly service rather then highest bidder.",
					...
					"Condottiero" = "Hailing from Etrusca, you owe the Duke your life, and as such you've did the one thing unthinkable for one of the Condotterio. You've traded sellsword opportunism for a stable life.")
...
/datum/outfit/job/roguetown/vet/merc/pre_equip(mob/living/carbon/human/H)
	...
	switch(classchoice)
		...
		if("Condottiero") //Crossbow Specialist Former Scout who is nowhere as versatile in training.
			to_chat(H, span_warning("A crossbowmen hailing from Etrusca, you owe the Duke your life, and as such you've did the one thing unthinkable for one of the Condotterio. You've traded sellsword opportunism for stable employment."))
