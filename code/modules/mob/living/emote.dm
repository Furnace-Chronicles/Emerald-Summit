...
/datum/emote/living/stat_roll/endurance
	...
	attempt_message_list = list(
		"tightens their resolve and prepares to endure...",
		"takes a deep breath and steels themselves...",
		"prepares to push through the strain...",
	)

	success_message_list = list(
		"pushes through and keeps going!",
		"outlasts the challenge!",
		"keeps going despite the strain!",
	)

	failure_message_list = list(
		"runs out of steam...",
		"collapses from exhaustion...",
		"can't keep up and falters...",
	)
