/mob/living/carbon/human/species/goblin
	...
	// Default corpse rot: the old goblin-specific rot subtype was slower than the NPC decay
	// path is now, self-deleted at 20 minutes, and never dusted the remains.
