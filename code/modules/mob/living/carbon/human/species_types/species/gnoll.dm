...
/datum/species/gnoll/on_species_gain(mob/living/carbon/C, datum/species/old_species)
	...
	// Upstream COMSIG_MOVABLE_BARK signal absent in ES — bark-cancel signal not registered.
	C.ambushable = FALSE
...
/datum/species/gnoll/on_species_loss(mob/living/carbon/C)
	...
	// Upstream COMSIG_MOVABLE_BARK signal absent in ES — nothing to unregister.
