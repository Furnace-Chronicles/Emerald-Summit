...
/datum/species/anthromorph
	...
	sub_name = "Wild-Kin"
	use_titles = TRUE
	race_titles = list("Bat-Kin", "Bee-Kin", "Bear-Kin", "Bird-Kin", "Boar-Kin", "Bull-Kin", "Cabbit-Kin", "Cat-Kin", "Cow-Kin", "Coyote-Kin", "Crocodile-Kin", "Deer-Kin", "Dog-Kin", "Donkey-Kin", "Fish-Kin", "Goat-Kin", "Horse-Kin", "Hyena-Kin", "Jackal-Kin", "Leech-Kin", "Leopard-Kin", "Lion-Kin", "Lynx-Kin", "Moose-Kin", "Monkey-Kin", "Otter-Kin", "Panda-Kin", "Panther-Kin", "Pig-Kin", "Possum-Kin", "Rabbit-Kin", "Rous-Kin", "Seal-Kin", "Shark-Kin", "Sheep-Kin", "Snake-Kin", "Spider-Kin", "Tiger-Kin", "Venard-Kin", "Volf-Kin", "Monster-Kin", "Chimera")
	desc = "<b>Wild-Kin</b><br>\
	A product of the Ten's enigmatic meddling in mortal races. The average wild-kin suffers from animalistic urges that vary in severity, \
