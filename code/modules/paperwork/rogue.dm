...
/obj/item/paper/scroll/grudge
	...
	desc = "A copy you've taken with you. Unfortunately the dampness of Readtun made it unreadable. You can still add new entries, however. It looks bulky enough to act as a mild blunt weapon."
...
/obj/item/paper/scroll/grudge/grand
	...
	desc = "A certified and well-made copy you've taken with you. Unfortunately the dampness of Readtun made it unreadable. You can still add new entries, however. It looks bulky enough to act as a decent blunt weapon."
	force = 20
...
/obj/item/paper/scroll/cargo/proc/rebuild_info()
	...
	if(signedname)
		info += "SIGNED,<br/>"
		info += "<font face=\"[FOUNTAIN_PEN_FONT]\" color=#27293f>[signedname] the [signedjob] of Readtun</font>"
