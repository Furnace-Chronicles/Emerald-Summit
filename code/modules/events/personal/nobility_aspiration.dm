/datum/round_event_control/sarael_nobility
	name = "Nobility Aspiration"
	track = EVENT_TRACK_PERSONAL
	typepath = /datum/round_event/sarael_nobility
	weight = 7
...
/datum/round_event_control/sarael_nobility/canSpawnEvent(players_amt, gamemode, fake_check)
	. = ..()
	if(!.)
		return FALSE
...
/datum/round_event/sarael_nobility/start()
	...
	to_chat(chosen_one, span_notice("Sarael wishes you to ascend in status! Become a part of the nobility to earn Sarael's favor!"))
