...
/datum/migrant_wave/adventurer
	...
	greet_text = "Together with a party of trusted friends we decided to venture out, seeking thrills, glory and treasure, ending up in the misty and damp bog underneath Scarlet Reach, perhaps getting ourselves into more than what we bargained for."
