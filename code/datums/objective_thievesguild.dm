...
/datum/objective/thieves_guild_objective/proc/setup_steal_objective()
    ...
    items = list(
        ...
        list("Crown of Emerald Summit", /obj/item/clothing/head/roguetown/crown/serpcrown),
...
/datum/objective/thieves_guild_objective/proc/setup_assassinate_objective()
    ...
    valid_roles = list("Grand Duke", "Prince", "Priest", "Priestess", "Councillor", "Acolyte", "Mystic Theurge", "Inquisitor", "Merchant", "Town Elder", "Guildmaster", "Steward", "Clerk")
