...
/datum/threes_away_game/New()
	. = ..()
	dc_since = list()
	START_PROCESSING(SSprocessing, src)

/datum/threes_away_game/Destroy()
...
/datum/threes_away_game/process(delta_time)
...
/obj/item/storage/pill_bottle/dice/threes_away/Destroy()
	if(active_game)
		var/datum/threes_away_game/G = active_game
		active_game = null
		qdel(G)
	return ..()
