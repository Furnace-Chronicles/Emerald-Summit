...
/datum/dice_poker_game/New()
	. = ..()
	dc_since = list()
	START_PROCESSING(SSprocessing, src)

/datum/dice_poker_game/Destroy()
...
/datum/dice_poker_game/process(delta_time)
...
/obj/item/storage/pill_bottle/dice/dice_poker/Destroy()
	if(active_game)
		var/datum/dice_poker_game/G = active_game
		active_game = null
		qdel(G)
	return ..()
