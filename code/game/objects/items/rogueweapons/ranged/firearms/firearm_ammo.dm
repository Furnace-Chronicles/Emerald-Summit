...
/obj/projectile/bullet/firearm
	...
	npc_damage_mult = 4//320, at 80 base. (RW npc_simple_damage_mult -> ES npc_damage_mult)
...
/obj/projectile/bullet/firearm/grapeshot
	...
	damage = 30
	range = 15
	npc_damage_mult = 4//720 potential, if all hit. (RW npc_simple_damage_mult -> ES npc_damage_mult)
