...
/datum/dwarven_dice_game/New()
	. = ..()
	dc_since = list()
	START_PROCESSING(SSprocessing, src)

/datum/dwarven_dice_game/Destroy()
...
/datum/dwarven_dice_game/process(delta_time)
...
/obj/item/storage/pill_bottle/dice/dwarven/Destroy()
	if(active_game)
		var/datum/dwarven_dice_game/G = active_game
		active_game = null
		qdel(G)
	return ..()
